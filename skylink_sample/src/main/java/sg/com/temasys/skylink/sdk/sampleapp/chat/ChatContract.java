...
public interface ChatContract {
    ...
    interface Presenter {
         ...
         */
        void processConnectedLayout(String roomName);
         ...
         */
        void processSelectMessageType(MESSAGE_TYPE message_type);
        ...
        void processSelectMessageFormat(MESSAGE_FORMAT formatMsg);
