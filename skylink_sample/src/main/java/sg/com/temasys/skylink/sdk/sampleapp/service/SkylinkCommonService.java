...
public abstract class SkylinkCommonService implements LifeCycleListener, MediaListener, OsListener, RemotePeerListener, MessagesListener,
     ...
     * @param typeCall
     */
    public void connectToRoom(Constants.CONFIG_TYPE typeCall, String roomName) {
        skylinkConnectionManager.connectToRoomByAppKey(typeCall, roomName);

        // we can use another method to connect to the room
        // skylinkConnectionManager.connectToRoomByConnectionString(typeCall, roomName);
    }
